...
The project ingests PDF documents, extracts meaningful regions from each page, stores those regions as chunks, generates embeddings, retrieves the best matching chunks for a user question, and exposes model-server inference APIs for table QA, NLI verification, layout document QA, vision QA, and section classification.
