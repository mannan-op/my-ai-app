...
The project ingests PDF documents, extracts meaningful regions from each page, stores those regions as chunks, generates embeddings, retrieves the best matching chunks for a user question, and exposes model-server inference APIs for table QA and NLI verification.
...
See [[Milestones/Milestone 4 - Hybrid Retrieval]] and [[Milestones/Milestone 5 - Model Server]].
